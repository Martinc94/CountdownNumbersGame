...
;This script contain my solution to the countdown numbers game.
;The user can pass in a target number and a list of 6 numbers and the script will compute a solution if one exists
;Example of method: (solvecount 120 (list 100 6 5 5 2 2)) - 120 is the target number and (list 100 6 5 5 2 2) is the list of 6 numbers

;If correct solution is found it is printed out to the screen
;If no answer is found a message will be printed to the screen "No Match Found"
...
;///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
;removes last two elements off list - used to remove last two off stack
...
;///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
;combines 3 (op and 2 nums into list) into a single list to be evaluated in performOp '(+ 1 2)
...
;///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
;returns the target if found in given in RPN list
...
;///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
;returns the rpn that sums to target - e.g. '(10 100 - 2 + 2 * 1 + 3 +)
(define (returnList target rpnLists)
  ...
  (if(= (compareToTarget target (car rpnLists)) target)
     ...
     (returnList target (cdr rpnLists))));recurse if not equal to target
)
...
(define (compareListsToTarget target rpnLists)
  ...
  (if(= (compareListToTarget target (car rpnLists)) target)
     ...
     (compareListsToTarget target (cdr rpnLists))));recurse if not equal to target
)
